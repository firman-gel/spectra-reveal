...
const SUBDIVISIONS_DATA: Subdivision[] = [
  {
    ...
    members: [
      ...
      { name: "Nanay", role: "Nayla Novianti", badge: "2", color: "text-mario-yellow", bgGlow: "bg-mario-yellow/5 border-mario-yellow/20", photo: "/photos/nanay.jpg" },
      { name: "Siti", role: "Siti Nurhalimah", badge: "3", color: "text-mario-yellow", bgGlow: "bg-mario-yellow/5 border-mario-yellow/20", photo: "/photos/siti.jpg" },
    ],
  },
  {
    id: 2,
    ...
    members: [
      ...
      { name: "Naima", role: "Naima Sahitya Andini", badge: "2", color: "text-mario-red", bgGlow: "bg-mario-red/5 border-mario-red/20", photo: "/photos/naima.jpg" },
      { name: "Dara", role: "Darasadiah Isnaini Salsabila", badge: "3", color: "text-mario-red", bgGlow: "bg-mario-red/5 border-mario-red/20", photo: "/photos/dara.jpg" },
    ],
  },
  {
    id: 3,
    ...
    members: [
      ...
      { name: "Aldan", role: "Raden Muhammad Rizky Aldani", badge: "2", color: "text-mario-blue", bgGlow: "bg-mario-blue/5 border-mario-blue/20", photo: "/photos/aldan.jpg" },
      { name: "Nayya", role: "Nayyara Varda Wistan", badge: "3", color: "text-mario-blue", bgGlow: "bg-mario-blue/5 border-mario-blue/20", photo: "/photos/nayya.jpg" },
    ],
  },
];
